...
WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/span_Lp chng mnh'))

WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/div_Chn nhm_ng-input'))

WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/span_GO (Lp chng mnh)'))
...
// Kiểm tra xem sau khi giao bài tập xong có thông báo giao thành công hay không

WebUI.verifyEqual(WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Hc liu - Sch Mm/div_Giao bi tp thnh cng'), 30), true)
