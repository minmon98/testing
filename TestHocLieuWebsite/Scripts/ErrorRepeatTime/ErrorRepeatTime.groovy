...
// Kiểm tra xem có hiện thông báo không hợp lệ khi nhập thời gian làm bài là số âm hay không

WebUI.verifyEqual(WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Hc liu - Sch Mm/div_S ln lm li phi ln hn hoc bng 0'), 30), true)
