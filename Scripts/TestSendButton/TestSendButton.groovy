...
WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/div_ s dng bn cn ng nhp hoc  Tham gia lm bi tp                                                                                          Khc'))

WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/a_ng nhp'))

WebUI.setText(findTestObject('Object Repository/Page_ng nhp  Sch Mm/input_a ch email_useremail'), 'phivanminh7@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_ng nhp  Sch Mm/input_Mt khu_userpassword'), '3+lYVVTSLh6WINX1sduPvw==')
...
WebUI.setText(findTestObject('Object Repository/Page_Hc liu - Sch Mm/textarea_abcde_message_content'), 'Hello World ')
